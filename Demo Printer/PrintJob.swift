...
//        let wkWebView = WKWebView(frame: viewController!.view.bounds)
        let wkWebView = WKWebView(frame: CGRect(origin: .zero, size: CGSize(width: 150, height: 50))) // A4 size
...
//                self.printing.onHtmlRendered(printJob: self, pdfData: pdfData as Data)
    ...
    static func pickPrinter( withSourceRect rect: CGRect) {
